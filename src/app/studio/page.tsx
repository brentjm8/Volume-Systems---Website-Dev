  ...
  makesOffer: [
    ...
    },
    {
      ...
      itemOffered: {
        ...
        name: "Alliance",
        description:
          "Partnership intelligence dashboard that turns messy CRM exports into strategic clarity for SaaS teams. Upload CSVs, get AI-powered insights, export board-ready briefs.",
        applicationCategory: "BusinessApplication",
        operatingSystem: "Web",
        featureList: [
          "CSV Upload Wizard",
